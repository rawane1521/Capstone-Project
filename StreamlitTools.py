...
if Menu == "Home":st.write("77% believe there is a gap between the job requirementsand the university graduate qualifications. As the world moves at a rapid pace towards digitalization, the gap  is exponentially growing.")
if Menu == "Home":st.write("Accordingly, we have assumed the responsibility of addressing this gap.")
